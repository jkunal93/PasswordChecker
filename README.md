...
python checkmypassword.py password123

You can also check multiple passwords at once:

python checkmypassword.py password123 myPassword securePass

Example output:

'password123' was hacked 9823456 times. You should choose a different password.
'mySecurePassword!' was NEVER hacked. You can use this password.
